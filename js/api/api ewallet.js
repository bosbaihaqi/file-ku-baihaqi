...
let path = "/transaction/create/ewallet";
let method = "POST";
...
// Gunakan hexMD5 dari library, contoh:
// let signature = md5(path+method+merchant_ref+amount+expired_duration+signature_key).toString();
